...
public class SeeminglyUnmodifiable {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Try 2 - Map updated! The LeftCamel's start is now at [ " + newCamelLoc
        .getX() + ", " + newCamelLoc.getY() + " ]");

//    locations.replace("LeftCamel",new Point(1, 7));
